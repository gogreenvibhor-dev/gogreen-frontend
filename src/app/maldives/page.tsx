...
export const metadata: Metadata = {
  title: "Vidhi Enterprises - Maldives Irrigation Solutions",
    ...
    <>
      ...
      <div className="container-fluid page-header py-5 mb-5 mt-2" style={{ backgroundImage: 'url(https://d170mw2nhcb1v0.cloudfront.net/img/head-eco.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="container text-center py-5">
          <h1 className="display-3 text-white mb-4">Maldives</h1>
          ...
          <div className="container">
            <div className="text-center mx-auto" style={{ maxWidth: '500px' }}>
              <h6 className="display-8 mb-5 fw-bolder" style={{ color: 'rgba(16, 16, 223, 0.668)', fontSize: 'x-large' }}>
                Welcome to our Maldives irrigation solutions page.
              </h6>
              ...
              <div className="row">
                <div className="col-md-8 text-justify">
                  ...
                  <ul className="box" style={{ color: 'rgb(3, 3, 123)', textAlign: 'justify', fontSize: 'medium', fontWeight: 'bolder' }}>
                    <li className="mt-2">Drip pipes</li>
                    <li className="mt-2">Mini sprinklers</li>
                    <li className="mt-2">Foggers & misters</li>
                    <li className="mt-2">Small filtration units</li>
                    <li className="mt-2">HDPE pipes (coastal-grade)</li>
                  </ul>
                  <hr style={{ border: '1px solid darkgreen' }} />
                  ...
                  <hr style={{ border: '3px solid darkgreen' }} />
                  <ul className="box" style={{ color: 'rgb(3, 3, 123)', textAlign: 'justify', fontSize: 'medium', fontWeight: 'bolder' }}>
                    <li className="mt-2">Resorts</li>
                    <li className="mt-2">Landscaping contractors</li>
                    <li className="mt-2">Nurseries</li>
                    <li className="mt-2">Home gardens</li>
                  </ul>
                  <hr style={{ border: '1px solid darkgreen' }} />
                  ...
                  <hr style={{ border: '3px solid darkgreen' }} />
                  <ul className="box" style={{ color: 'rgb(3, 3, 123)', textAlign: 'justify', fontSize: 'medium', fontWeight: 'bolder' }}>
                    <li className="mt-2">Coastal-resistant materials</li>
                    <li className="mt-2">Compact systems for small landscaped areas</li>
                    <li className="mt-2">Trusted supplier for resort irrigation</li>
                  </ul>
                  <hr style={{ border: '1px solid darkgreen' }} />
                </div>
                <div className="col-md-4 mt-5" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                  <div className="image_2 mt-5">
                    <Image src="https://d170mw2nhcb1v0.cloudfront.net/img/Malawi.png" alt="Maldives Flag" />
                  </div>
                </div>
              </div>
            </div>
