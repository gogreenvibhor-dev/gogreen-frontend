...
const ContactPage = () => {
  ...
  return (
    <main className="min-h-screen bg-whitesmoke">
      <Navbar />
      <header className="relative h-[45vh] min-h-[450px] flex items-center justify-center text-center text-white overflow-hidden mb-20">
        <Image
          src="https://d170mw2nhcb1v0.cloudfront.net/img/cu.png"
        ...
        <div className="container mx-auto px-4 relative z-20">
          <h1 className="text-5xl lg:text-7xl font-bold mb-6 font-heading text-green-900 drop-shadow-lg">Contact Us</h1>
          <nav className="flex justify-center">
            <ol className="flex items-center space-x-2 bg-white/20 px-6 backdrop-blur-sm py-2 rounded-full font-bold">
              ...
              <li className="text-green-700">Contact</li>
            </ol>
          </nav>
        </div>
      </header>
