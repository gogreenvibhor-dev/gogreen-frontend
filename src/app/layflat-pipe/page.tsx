...
export default function LayFlatPipe() {
  return (
    <>
      ...
      {/* Page Header */}
      <div className="container-fluid page-header py-5 mb-5 mt-2" style={{ backgroundImage: 'url(/img/eco-head-7.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
              ...
              <div className="col-md-6">
                <div className="box_main">
                  <div className="image_2">
                    <img src="/img/Eco-20.png" style={{ width: '600px', height: '700px' }} alt="Lay Flat Pipe" />
                  </div>
                </div>
              </div>
