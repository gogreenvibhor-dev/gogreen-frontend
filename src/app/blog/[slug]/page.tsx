    ...
    <main className="min-h-screen bg-[#f6fff7]">
      ...
      <article className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          <Link 
            href="/blog" 
            className="inline-flex items-center gap-2 bg-success px-8 text-green-900 py-3 rounded-full font-bold hover:bg-[#145a32] transition-all duration-300 shadow-lg hover:shadow-xl hover:text-white"
          >
