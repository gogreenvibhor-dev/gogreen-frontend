...
export const metadata: Metadata = {
  title: "Vidhi Enterprises - Mexico Irrigation Solutions",
  description: "Vidhi Enterprises exports drip systems, orchard drippers, sprinklers and filters for Mexico's fruit, vegetable and plantation farms.",
    ...
    <>
      ...
      <div className="container-fluid page-header py-5 mb-5 mt-2" style={{ backgroundImage: 'url(https://d170mw2nhcb1v0.cloudfront.net/img/head-eco.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="container text-center py-5">
          <h1 className="display-3 text-white mb-4">Mexico</h1>
          ...
          <div className="container">
            <div className="text-center mx-auto" style={{ maxWidth: '500px' }}>
              <h6 className="display-8 mb-5 fw-bolder" style={{ color: 'rgba(16, 16, 223, 0.668)', fontSize: 'x-large' }}>
                Welcome to our Mexico irrigation solutions page.
              </h6>
              ...
              <div className="row">
                <div className="col-md-8 text-justify">
                  ...
                  <ul className="box" style={{ color: 'rgb(3, 3, 123)', textAlign: 'justify', fontSize: 'medium', fontWeight: 'bolder' }}>
                    <li className="mt-2">Inline drip lines</li>
                    <li className="mt-2">PC & Non-PC drippers</li>
                    <li className="mt-2">Mini & micro sprinklers</li>
                    <li className="mt-2">Filtration units (disc & screen)</li>
                    <li className="mt-2">HDPE pipes & fittings</li>
                  </ul>
                  <hr style={{ border: '1px solid darkgreen' }} />
                  ...
                  <hr style={{ border: '3px solid darkgreen' }} />
                  <ul className="box" style={{ color: 'rgb(3, 3, 123)', textAlign: 'justify', fontSize: 'medium', fontWeight: 'bolder' }}>
                    <li className="mt-2">Fruit orchards</li>
                    <li className="mt-2">Vegetable farms</li>
                    <li className="mt-2">Greenhouses</li>
                    <li className="mt-2">Commercial plantations</li>
                  </ul>
                  <hr style={{ border: '1px solid darkgreen' }} />
                  ...
                  <hr style={{ border: '3px solid darkgreen' }} />
                  <ul className="box" style={{ color: 'rgb(3, 3, 123)', textAlign: 'justify', fontSize: 'medium', fontWeight: 'bolder' }}>
                    <li className="mt-2">Durable systems suitable for varied climates</li>
                    <li className="mt-2">Efficient water-saving technologies</li>
                    <li className="mt-2">Trusted exporter to Latin American markets</li>
                  </ul>
                  <hr style={{ border: '1px solid darkgreen' }} />
                </div>
                <div className="col-md-4 mt-5" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                  <div className="image_2 mt-5">
                    <Image src="https://d170mw2nhcb1v0.cloudfront.net/img/Mexico.png" alt="Mexico Flag" />
                  </div>
                </div>
              </div>
            </div>
