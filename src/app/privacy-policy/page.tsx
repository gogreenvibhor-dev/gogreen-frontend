      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            <h2 className="text-3xl font-bold text-green-900 mb-6">Who We Are</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">What Personal Data We Collect and Why We Collect It</h2>
            
            <h3 className="text-xl font-semibold text-green-900 mb-2">Contact / Enquiry Forms</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-green-900 mb-2">Subscribe / Newsletter Forms</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-green-900 mb-2">Media</h3>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">Cookies</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">Embedded Content from Other Websites</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">Who We Share Your Data With</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">What Rights You Have Over Your Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">Where We Send Your Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">How We Protect Your Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">What Data Breach Procedures We Have in Place</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">What Third Parties We Receive Data From</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">General Data Protection Regulation (GDPR)</h2>
            <p>
            ...
            <h3 className="text-xl font-semibold text-green-800 mt-6 mb-2">Your GDPR Rights (EEA Residents)</h3>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">Log Files</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">Third-Party Privacy Policies</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">Children’s Information</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">Online Privacy Policy Only</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-green-900 mb-4">Consent</h2>
            <p>
