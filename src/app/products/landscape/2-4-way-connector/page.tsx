...
export default function LandscapeConnector() {
  const breadcrumbs = [
    { label: "Home", href: "/" },
            ...
            <div className="space-y-8">
              ...
              <div className="bg-whitesmoke p-6 rounded-xl border-l-4 border-primary mt-6">
                ...
                <p className="text-lg text-gray-700 font-medium leading-relaxed italic">
                  <b>Widely used in home gardens, polyhouses, greenhouses, and nurseries to extend two outlets from a single dripper/emitter, ensuring balanced and efficient watering across multiple plants.</b>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="order-2 lg:order-1 space-y-8">
              ...
              <div className="bg-whitesmoke p-6 rounded-xl border-l-4 border-primary mt-6 mb-8">
                <h3 className="text-2xl font-bold text-primary mb-3">Application</h3>
                <p className="text-lg text-gray-700 font-medium leading-relaxed italic">
                  <b>Perfect for Home Gardens, Poly Houses, Green Houses, and Nurseries — efficiently distributing water to four plants from one emitter, ensuring uniform irrigation and improved water efficiency.</b>
                </p>
              </div>
