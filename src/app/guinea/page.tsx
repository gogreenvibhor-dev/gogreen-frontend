          ...
          <div className="container">
            <div className="text-center mx-auto" style={{ maxWidth: '500px' }}>
              <h6 className="display-8 mb-5 fw-bolder" style={{ color: 'rgba(16, 16, 223, 0.668)', fontSize: 'x-large' }}>
                Welcome to our Guinea irrigation solutions page.
              </h6>
              ...
              <div className="row">
                <div className="col-md-8 text-justify">
                  ...
                  <ul className="box" style={{ color: 'rgb(3, 3, 123)', textAlign: 'justify', fontSize: 'medium', fontWeight: 'bolder' }}>
                    <li className="mt-2">Drip lines & drippers</li>
                    <li className="mt-2">Micro sprinklers</li>
                    <li className="mt-2">Garden sprayers</li>
                    <li className="mt-2">Basic filtration units</li>
                  ...
                  <ul className="box" style={{ color: 'rgb(3, 3, 123)', textAlign: 'justify', fontSize: 'medium', fontWeight: 'bolder' }}>
                    ...
                    <li className="mt-2">Community farms</li>
                  </ul>
                  <hr style={{ border: '1px solid darkgreen' }} />
                  ...
                  <hr style={{ border: '3px solid darkgreen' }} />
                  <ul className="box" style={{ color: 'rgb(3, 3, 123)', textAlign: 'justify', fontSize: 'medium', fontWeight: 'bolder' }}>
                    <li className="mt-2">Affordable and durable systems</li>
                    <li className="mt-2">Reliable performance in tropical weather</li>
                    <li className="mt-2">Easy installation for rural areas</li>
                  </ul>
                  <hr style={{ border: '1px solid darkgreen' }} />
                </div>
