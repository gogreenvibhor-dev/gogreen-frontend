      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
            <h1 className="text-4xl font-bold text-green-900 mb-6">{country.title}</h1>
            ...
            {country.marketInsights && (
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-green-900 mb-4">Market Insights</h3>
            ...
            {country.productsSupplied && (
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-green-900 mb-4">Products We Supply</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            {country.industriesServed && (
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-green-900 mb-4">Industries We Serve</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            {country.whyChoose && (
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-green-900 mb-4">Why Choose Vidhi Enterprises</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
